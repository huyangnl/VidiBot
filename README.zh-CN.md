...
### 批量任务列表
![VidiBot Task List](./images/task_list.png)
![VidiBot Task List](./images/task_list02.png)
![VidiBot Task List](./images/task_list03.png)

### 指纹窗口列表示例
![VidiBot Upload Config](./images/fingerprint-env.png)

### 运行状态与日志
![VidiBot Running Log](./images/running-log.png)
