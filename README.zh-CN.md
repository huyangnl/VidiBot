...
## 📸 演示截图 / 动图
### 主界面
<img src="https://github.com/huyangnl/VidiBot/blob/main/images/dashboard.png">

### 批量任务列表
![VidiBot Task List](./docs/images/task-list.png)
![VidiBot Task List](./docs/images/task-list02.png)
![VidiBot Task List](./docs/images/task-list03.png)

### 指纹窗口列表示例
![VidiBot Upload Config](./docs/images/fingerprint-env.png)

### 运行状态与日志
![VidiBot Running Log](./docs/images/running-log.png)
